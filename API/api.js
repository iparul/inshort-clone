...
export const getNewsAPI = (category, country = "in") => {
  ...
  //   return `https://newsapi.org/v2/top-headlines?country=general&category=in&apiKey=2d11e7f031b54e15801ccbfbfdcf09bf`;
  return `https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&apiKey=2d11e7f031b54e15801ccbfbfdcf09bf`;
};
